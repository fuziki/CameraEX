//
//  CameraEXCameraExtensionProvider.swift
...
class CameraEXCameraExtensionDeviceSource: NSObject, CMIOExtensionDeviceSource {
	...
	private var _streamSource: CameraEXCameraExtensionStreamSource!
	...
	init(localizedName: String) {
		...
		_streamSource = CameraEXCameraExtensionStreamSource(localizedName: "SampleCapture.Video", streamID: videoID, streamFormat: videoStreamFormat, device: device)
		do {
...
class CameraEXCameraExtensionStreamSource: NSObject, CMIOExtensionStreamSource {
...
class CameraEXCameraExtensionProviderSource: NSObject, CMIOExtensionProviderSource {
